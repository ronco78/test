...
/**
 * struct nvme_tcp_h2c_term_pdu - nvme tcp host to controller terminate
 *     connection pdu
 *
 * @hdr:           pdu common header
 * @pfv:           pdu version format
...
/**
 * struct nvme_tcp_c2h_term_pdu - nvme tcp controller to host terminate
 *     connection pdu
 *
 * @hdr:           pdu common header
 * @pfv:           pdu version format
